 ...
 */
public abstract class Wraith extends Monster {

    /**
     * The data holding a Player's name.
     */
    private static final EntityDataAccessor<String> PLAYER_NAME = SynchedEntityData.defineId(Wraith.class, EntityDataSerializers.STRING);
     ...
     */
    public Wraith(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
     ...
     */
    public Wraith(EntityType<? extends Monster> type, Location location, String playerName) {
