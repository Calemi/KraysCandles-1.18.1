...
public class InitEntityTypes {
    ...
    public static final RegistryObject<EntityType<WraithDamnedBoss>> WRAITH_DAMNED = ENTITY_TYPES.register("wraith_damned", () -> EntityType.Builder.<WraithDamnedBoss>of(WraithDamnedBoss::new, MobCategory.MONSTER).sized(2.5F, 5F).build(new ResourceLocation(KCReference.MOD_ID, "wraith_damned").toString()));

    public static final RegistryObject<EntityType<Vampire>> VAMPIRE = ENTITY_TYPES.register("vampire", () -> EntityType.Builder.<Vampire>of(Vampire::new, MobCategory.MONSTER).sized(0.8F, 1.8F).build(new ResourceLocation(KCReference.MOD_ID, "vampire").toString()));

    public static <T extends Wraith> RegistryObject<EntityType<T>> regWraith(String type, EntityType.EntityFactory<T> sup) {
        return ENTITY_TYPES.register("wraith_" + type, () -> EntityType.Builder.of(sup, MobCategory.MONSTER).sized(0.8F, 1.8F).build(new ResourceLocation(KCReference.MOD_ID, "wraith_" + type).toString()));
    }
}
