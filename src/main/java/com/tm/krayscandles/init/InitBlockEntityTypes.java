...
public class InitBlockEntityTypes {
    ...
    //public static final RegistryObject<BlockEntityType<BlockEntityCandleMount>> CANDLE_SOY_MOUNT = BLOCK_ENTITY_TYPES.register(
    ...
    //        "lantern_soul_trapped", () -> new BlockEntityType<>(TileEntityLanternSoulTrapped::new, Sets.newHashSet(InitItems.BLOCK_ENTITY_TYPES.get()), null));
