...
public class InitSounds {
    ...
    public static final RegistryObject<SoundEvent> VAMPIRE_COUNT_AMBIENT = SOUNDS.register("entity.vampire_ambient", () -> new SoundEvent(new ResourceLocation(KCReference.MOD_ID, "entity.vampire_ambient")));
    public static final RegistryObject<SoundEvent> VAMPIRE_COUNT_HURT = SOUNDS.register("entity.vampire_hurt", () -> new SoundEvent(new ResourceLocation(KCReference.MOD_ID, "entity.vampire_hurt")));
    public static final RegistryObject<SoundEvent> VAMPIRE_COUNT_DEATH = SOUNDS.register("entity.vampire_death", () -> new SoundEvent(new ResourceLocation(KCReference.MOD_ID, "entity.vampire_death")));
    public static final RegistryObject<SoundEvent> VAMPIRE_COUNT_VANISH = SOUNDS.register("entity.vampire_vanish", () -> new SoundEvent(new ResourceLocation(KCReference.MOD_ID, "entity.vampire_vanish")));
    ...
    public static final RegistryObject<SoundEvent> VAMPIRE_BARONESS_HURT = SOUNDS.register("entity.vampire_baroness_hurt", () -> new SoundEvent(new ResourceLocation(KCReference.MOD_ID, "entity.vampire_baroness_hurt")));
