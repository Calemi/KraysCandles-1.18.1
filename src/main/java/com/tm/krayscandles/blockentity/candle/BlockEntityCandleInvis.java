...
public class BlockEntityCandleInvis extends BlockEntityCandleBase {

    public BlockEntityCandleInvis(BlockPos pos, BlockState state) {
        super(InitBlockEntityTypes.CANDLE_INVIS.get(), pos, state);
    }

    @Override
    public MobEffectInstance[] getCandleEffects() {
        return new MobEffectInstance[] {new MobEffectInstance(MobEffects.INVISIBILITY)};
    }
