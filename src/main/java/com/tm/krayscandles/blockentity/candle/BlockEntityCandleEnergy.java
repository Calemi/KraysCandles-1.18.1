...
public class BlockEntityCandleEnergy extends BlockEntityCandleBase {
    ...
    public BlockEntityCandleEnergy(BlockPos pos, BlockState state) {
        super(InitBlockEntityTypes.CANDLE_ENERGY.get(), pos, state);
    }

    @Override
    public MobEffectInstance[] getCandleEffects() {
        return new MobEffectInstance[] {new MobEffectInstance(MobEffects.MOVEMENT_SPEED)};
    }
